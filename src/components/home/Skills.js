    ...
    return (
        <div id="skills" className="bg-white">
            <Container fluid className="p-5">
                ...
                <Tabs justify id="skills-tabs" defaultActiveKey="technical-skills">
                    <Tab tabClassName="lead" eventKey="technical-skills" title="Technical Skills">
                        <Row className="pt-5">
                    ...
                    <Tab tabClassName="lead" eventKey="soft-skills" title="Soft Skills">
                    </Tab>
                </Tabs>
            </Container>
        </div>
